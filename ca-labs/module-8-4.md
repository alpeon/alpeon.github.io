...
<img src="./../assets/ca-images/module8_lab4/s1.png" class="img_80_percent">
    
## 8.4.2

There are no backups made yet, so proceed to the next page.

<img src="./../assets/ca-images/module8_lab4/s2.png" class="img_80_percent">
    
## 8.4.3

Select the backup datastore and proceed with **Finish**.

<img src="./../assets/ca-images/module8_lab4/s3.png" class="img_80_percent">
    
## 8.4.4

Wait until the VM is back to the **RUNNING** state.

<img src="./../assets/ca-images/module8_lab4/s4.png" class="img_80_percent">
    
## 8.4.5

From the **VM actions** drop-down list select the **Recover** option.

<img src="./../assets/ca-images/module8_lab4/s5.png" class="img_80_percent">
    
## 8.4.6

Select the **Recreate** option from the list and press the **Accept** button.

<img src="./../assets/ca-images/module8_lab4/s6.png" class="img_80_percent">
   
## 8.4.7

Wait untl the VM is in the **RUNNING** state.

<img src="./../assets/ca-images/module8_lab4/s7.png" class="img_80_percent">

## 8.4.8

Go back to an app's **/get-data** page.

<img src="./../assets/ca-images/module8_lab4/s8.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s9.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s10.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s11.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s12.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s13.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s14.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s15.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s16.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s17.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s18.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s19.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s20.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab4/s21.png" class="img_80_percent">
