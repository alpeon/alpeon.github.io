...
<img src="./../assets/ca-images/module8_lab3/s1.png" class="img_80_percent">

## 8.3.2

From the list of templates select the **alpine-db-server** VM Template.

<img src="./../assets/ca-images/module8_lab3/s2.png" class="img_80_percent">

## 8.3.3

Keep everything **as is** and proceed to the next configurations screen.

<img src="./../assets/ca-images/module8_lab3/s3.png" class="img_80_percent">

## 8.3.4

Switch to the **Placement** tab and select the **prod-cluster** cluster from the list.

<img src="./../assets/ca-images/module8_lab3/s4.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab3/s5.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab3/s6.png" class="img_80_percent">

## 8.3.7

From the VM Template list select the **ubuntu-application** VM Template.

<img src="./../assets/ca-images/module8_lab3/s7.png" class="img_80_percent">
    
## 8.3.8

Keep the Configuration as is and proceed to the **User inputs**.

<img src="./../assets/ca-images/module8_lab3/s8.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab3/s9.png" class="img_80_percent">

## 8.3.10

Go to the **Placement** tab and set the cluster requirement to **prod-cluster**.

<img src="./../assets/ca-images/module8_lab3/s10.png" class="img_80_percent">
    
## 8.3.11

Wait until the newly deployed VM is **running**. 

<img src="./../assets/ca-images/module8_lab3/s11.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab3/s12.png" class="img_80_percent">
...
<img src="./../assets/ca-images/module8_lab3/s13.png" class="img_80_percent">
    
## 8.3.14

Make sure that the page is working and get yourself familiar with the instructions.

<img src="./../assets/ca-images/module8_lab3/s14.png" class="img_80_percent">
   
## 8.3.15

Visit the **/create-db** page to create the database. 

<img src="./../assets/ca-images/module8_lab3/s15.png" class="img_80_percent">
    
## 8.3.16

You **must get the success message, otherwise stop and debug the connectivity between your VMs**.

<img src="./../assets/ca-images/module8_lab3/s16.png" class="img_80_percent">
    
## 8.3.17

Now visit the **/insert-dummy** page.

<img src="./../assets/ca-images/module8_lab3/s17.png" class="img_80_percent">
    
## 8.3.18

Refresh the page 3 to 4 times to generate more of the dummy data.

<img src="./../assets/ca-images/module8_lab3/s18.png" class="img_80_percent">
   
## 8.3.19

Now visit the **/get-data** page to print the contents of the database. 

<img src="./../assets/ca-images/module8_lab3/s19.png" class="img_80_percent">
   
## 8.3.20

Your data must be printed.

<img src="./../assets/ca-images/module8_lab3/s21.png" class="img_80_percent">					
